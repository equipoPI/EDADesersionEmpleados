...
input_data['Ingreso Mensual'] = st.number_input("Ingrese el valor del Ingreso Mensual", min_value=1009.0, max_value=19999.0, value=1009.0)
...
if st.button("Realizar Clasificación"):
    ...
    st.write("La satisfacción del empleado es:", prediction[0])